# Project on Predicting Movie Ratings
...
# 4. Separating training and validation data
...
# 5.Using Random Forest Method for Prediction
...
# 6. Caculating Accuracy of Random Forest Method through RMSE
...
# 7. Evaluaing Model Performance of Random Forest
